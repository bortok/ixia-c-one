...
Topology:
IXIA (40.40.40.0/24) -----> SONiC ------> IXIA (50.50.50.0/24)
Flows:
...
func TestSONiCIPv4BGPRouteInstall(t *testing.T) {
	...
	config, expected := bgpRouteInstallConfigSONiCIPv4(client)
...
func bgpRouteInstallConfigSONiCIPv4(client *helpers.ApiClient) (gosnappi.Config, helpers.ExpectedState) {
